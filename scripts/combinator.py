...
pref  = [ ['pullus'], ['ornis','ornithos'], ['avis'], ['kottos'], ['gallus', 'gallu'], ['alektryon'], ['pteron'], ['gallina']]
mid   = [ ['stercus'],['excrementum'],['kopros'], ['faex','faecis'], ['merda'],['kakke'],['enteron'],['intestinum'],[''] ]
terms = [ ['cola'], ['microbium'],['monas'],['spira'],['bios'],['bacterium'],['plasma'],['soma'],[''] ]
